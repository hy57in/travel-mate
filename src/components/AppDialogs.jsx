...
export default function AppDialogs({ dialog, setDialog, confirmDelete, setConfirmDelete, trip, trips, user, theme, setTheme, updateTrip, persist, reset, nextId, showToast, signInWithEmail, signInWithGoogle, signOut, createInvite }) {
  return (
    <>
