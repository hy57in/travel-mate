...
export default function AppHeader({ trips, activeId, setActiveId, trip, user, theme, setTheme, scrolled, ddayText, todayDayIndex, setExpandedDay, setDialog, shareTrip, showToast }) {
  return (
